...
export default function BurgerMenu({
  ...
  navT,
  showMobMenu,
}: Readonly<BurgerMenuProps>) {
  return (
    <div
      className={cn(
        showMobMenu ? 'wk_translate-x-0' : 'wk_translate-x-full',
        transition,
    ...
    >
      ...
      <div className="wk_bg-th_bg_secondary wk_rounded-50 wk_pr-[44px] wk_pl-[44px] wk_pt-[50px] wk_flex wk_flex-col wk_w-screen wk_h-screen">
        ...
        >
          <Svg
            id="close"
            className="wk_absolute wk_top-[50px] wk_right-[44px] wk_fill-gray_600 hover:wk_fill-th_hover active:wk_fill-th_accent"
          />
        </Link>
        ...
        <div className="wk_flex wk_flex-col wk_gap-[79px]">
          ...
          <div className="wk_flex wk_gap-[74px] wk_flex-col">
            ...
            <Button
              ...
              type="button"
              label="label"
              className="wk_w-full tablet:wk_hidden"
            />
          </div>
        </div>
      </div>
