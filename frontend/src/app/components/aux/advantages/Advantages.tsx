...
export default function Advantages({ t }: Readonly<AdvantagesProps>) {
  return (
    <ul
      className={`wk_flex wk_flex-col wk_items-center wk_justify-center wk_gap-[12px] mobile:wk_flex-row wk_flex-wrap desktop:wk_flex-nowrap desktop:wk_w-[1292px] tablet:wk_mx-auto wk_text-gray_300 wk_text-[16px] wk_leading-[${
        20 / 16
      }]`}
    >
