...
export default async function Page({ params: { lng } }: Readonly<PageProps>) {
  ...
  return (
    <section className="wk_mx-auto wk_mb-[12px] wk_pt-[384px] tablet:wk_pt-[364px] desktop:wk_pt-[308px] wk_pb-[40px] tablet:wk_pb-[86px] desktop:wk_pb-[30px] wk_px-[12px] tablet:wk_px-[52px] desktop:wk_px-[60px] wk_rounded-50 wk_bg-hero_pattern_smallMob mobile:wk_bg-hero_pattern_mob tablet:wk_bg-hero_pattern_tab wk_bg-center wk_bg-cover wk_w-auto">
