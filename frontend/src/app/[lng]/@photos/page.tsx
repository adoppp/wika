...
export default async function Page({ params: { lng } }: Readonly<PageProps>) {
  ...
  return (
    <section
      ...
      className="wk_mx-auto wk_mb-[12px] wk_px-[16px] wk_py-[52px] tablet:wk_px-[76px] tablet:wk_pt-[56px] tablet:wk_pb-[68px] desktop:wk_pt-[100px] desktop:wk_pb-[120px] desktop:wk_px-[68px] wk_rounded-50 wk_bg-th_black"
    >
