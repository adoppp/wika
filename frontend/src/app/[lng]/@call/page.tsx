...
export default async function Page({ params: { lng } }: Readonly<PageProps>) {
  ...
  return (
    <section className="desktop:wk_w-[1428px] wk_mx-auto wk_px-[16px] wk_py-[52px] tablet:wk_px-[68px] tablet:wk_pt-[56px] tablet:wk_pb-[68px] desktop:wk_pt-[120px] desktop:wk_pb-[108px] wk_rounded-50 wk_bg-th_black">
